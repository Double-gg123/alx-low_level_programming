 ...
 * @e_ident: A pointer to an array with  ELF  numbers.
 *
...
/**
 * print_magic - Prints the  numbers of an ELF .
 * @e_ident: A pointer to an array with  ELF  numbers.
 *
 ...
 * @e_ident: A pointer to an array with  ELF .
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident: A pointer to an array with the ELF .
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
